...
class HeroTableViewCell: UITableViewCell {
  ...
  private func setupUI() {
    ...
    descriptionLabel.text =
      "A powerful UIKit component that allows UISplitViewController to be pushed onto existing navigation hierarchies, enabling seamless integration of split view controllers into navigation stacks."
